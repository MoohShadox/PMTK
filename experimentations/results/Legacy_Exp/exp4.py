...
parser.add_argument('-ni','--n_items', type=int, default = 6)
parser.add_argument('-nt','--n_tests', type=int, default = 25)
...
EXP_TITLE = f"THETA_ELICITATION_CARD_{n_items}_{n_test_subsets}_2"

...
#OUTPUT = "vTHETA_VS_NOTHETA_01_01_9"
#n_tiers = 9
#alpha = 0.1
#p = 0.1
#run_exp("exp3.py",n_items = 5, n_reps = 20, t = n_tiers, n_test_subsets = 10, budget = 25, alpha = alpha, pr = p, n_evals = 5, output = OUTPUT)


OUTPUT = "vTHETA_VS_NOTHETA_03_03_9"
n_tiers = 9
alpha = 0.3
p = 0.3
run_exp("exp3.py",n_items = 5, n_reps = 20, t = n_tiers, n_test_subsets = 10, budget = 25, alpha = alpha, pr = p, n_evals = 5, output = OUTPUT)

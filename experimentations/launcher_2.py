...
#OUTPUT = "vCARD_03_03_12"

#n_tiers = 12
#alpha = 0.3
#p = 0.3
#run_exp("exp2.py",n_items = 5, n_reps = 20, t = n_tiers, n_test_subsets = 10, budget = 25, alpha = alpha, pr = p, n_evals = 5, output = OUTPUT)

OUTPUT = "vCARD_01_01_12"
